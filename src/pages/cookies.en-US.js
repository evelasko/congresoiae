  ...
  return (
    <Layout lang={langKey}>
      ...
      >
        ...
        <p>
          Fundación de la Danza Alicia Alonso informa acerca del uso de las
          cookies en su página web:{' '}
          <a
            href="http://www.congreso.alicialonso.org"
            target="_blank"
            class="url"
          >
            www.congreso.alicialonso.org
          </a>
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            usuario desde un equipo o dominio que no es gestionado por el
        ...
        <ul>
          <li>
            ...
            la navegación, almacenar contenidos para la difusión de vídeos o
          ...
          <li>
            ...
            función de una serie de criterios en el terminal del usuario como
            por ejemplo serian el idioma, el tipo de navegador a través del cual
          ...
          <li>
            ...
            en función del análisis de los datos de uso que hacen los usuarios
            del servicio.
          </li>
          <li>
            {' '}
            Cookies publicitarias: permiten la gestión, de la forma más eficaz
            posible, de los espacios publicitarios. Cookies de publicidad
            comportamental: almacenan información del comportamiento de los
          ...
          <li>
            ...
            que se generen únicamente para los usuarios de dichas redes
            sociales. Las condiciones de utilización de estas cookies y la
            información recopilada se regula por la política de privacidad de la
            plataforma social correspondiente.
          </li>
        </ul>
        ...
        <p>
          ...
          qué cookies quiere que funcionen en este sitio web. Puede usted
          ...
          su ordenador: Microsoft Internet Explorer o Microsoft Edge:{' '}
          <a
        ...
        <p>
          {' '}
          Ghostery:{' '}
          <a href="http://www.ghostery.com/" target="_blank" class="url">
            www.ghostery.com/
          </a>
        </p>
        <p>
        ...
        <p>
          Cookies utilizadas en{' '}
          <a href="https://congreso.alicialonso.org">
        ...
        <ul>
          <li>Cookies Propias: Cookies de Sesión</li>
          <li>Cookies de Terceros: Google Analytics</li>
        </ul>
        <p>
          Aceptación de la Política de cookies congreso.alicialonso.org asume
          que usted acepta el uso de cookies. No obstante, muestra información
          sobre su Política de cookies en la parte inferior o superior de
          cualquier página del portal con el objeto de que usted sea consciente.
        </p>
      </div>
      <Footer />
    </Layout>
