  ...
  honor: {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'Presidente de la Academia Española de Artes Escénicas',
      },
      {
        name: 'Doña. Adriana Moscoso',
        title:
          'Directora General de Industrias Culturales (Ministerio de Cultura)',
      },
      {
        name: 'D. Román Fernández  Baca-Casares',
        title:
          'Director General de Bellas Artes y Patrimonio (Ministerio de Cultura)',
      },
      {
